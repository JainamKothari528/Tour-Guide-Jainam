...
<div class="main-w3layouts wrapper">
		<h3>Search Tracking Place</h3><br>
		<div class="main-agileinfo">
			<div class="agileits-top">
                <form action="trackingprocess.php" method="post">
                <?php
	                    if($_GET["st"] != "")
                        {
            ...
            <?php
                ...
                if(isset($_GET["st"]))
                {
                    ...
                    $qe=$con->prepare("SELECT * FROM Tracking WHERE s_id=".$_GET['st']);
            ...
            ?>
                    <div class="divtxt">
            <?php
                        echo "Name = ".$rw["track_name"]."<br>";
                        echo "Description = ".$rw["track_des"]."<br>";
                        echo "Address = ".$rw["track_address"]."<br>";
                        echo "There are many Tour Guides in this State. Call <a href='guidewisesearch.php?st=$id'>Tour Guide</a> for this State.";
            ?>
                    </div>
                    <div class="divimg">
                    <img style="width:90%;height:300px" src="../Image/Tracking/<?php echo $rw['track_image']; ?>">
                    </img>
                    </div>
            <?php
                    }
